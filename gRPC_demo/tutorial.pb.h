...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_tutorial_2eproto_metadata_getter(int index);
...
class Point PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_tutorial_2eproto_metadata_getter(kIndexInFileMessages);
  }
